...
public function get_article(){
	...
	$res=$this->db->query("SELECT * FROM `blog_articles`,reciepient,systemuser WHERE blog_articles.article_user = reciepient.reciepientid AND reciepient.systemUser_systemUserId = systemuser.systemUserId");
