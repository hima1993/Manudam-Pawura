<div class="modal fade" id="infra" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" >
                <div class="modal-dialog" style="width: 650px; height: 2000px;" role="document">
                    <div class="modal-content modal-info col-md-12" id="grad1">
                        ...
                        <?php echo form_open_multipart('Recipient/AddprojectInfra'); ?> 

                                    
                                    <div class="col-md-12" id="signin"  style="margin-top: 10px;">
                                       <h3 style="text-align: center;" class=" w3-lobster w3-xxxlarge rainbow2"><b>ADD YOUR VALUABLE PROJECT HERE</b><br/><b>INFRASTRUCTURE REQUESTING</b></h3>
                                        <br>
                                            ...
                                            <div class=" col-md-12 row">
                                             ...
                                             <div id="role" class=" col-md-6 form-group" style="margin-top:10px; ">
                                                  <select class="form-control" id="eqpCategory" name="infracategory" required>
